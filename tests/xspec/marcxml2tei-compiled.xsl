...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}xspec-uri"
                 as="Q{http://www.w3.org/2001/XMLSchema}anyURI">file:/home/mathis/Dev/ABES/marcxml2tei/tests/marcxml2tei.xspec</xsl:variable>
   <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}is-external"
                 as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                 select="false()"/>
   <xsl:variable name="Q{urn:x-xspec:compile:impl}param-d62e2-doc" as="document-node()">
      <xsl:document>
         <xsl:text>fre</xsl:text>
      </xsl:document>
   </xsl:variable>
   <xsl:param name="Q{}primaryLanguage"
              select="$Q{urn:x-xspec:compile:impl}param-d62e2-doc ! ( node() )"/>
   <xsl:variable name="Q{urn:x-xspec:compile:impl}param-d62e4-doc" as="document-node()">
      <xsl:document>
         <xsl:text>fr</xsl:text>
      </xsl:document>
   </xsl:variable>
   <xsl:param name="Q{}primaryLanguageCode"
              select="$Q{urn:x-xspec:compile:impl}param-d62e4-doc ! ( node() )"/>
   <xsl:variable name="Q{urn:x-xspec:compile:impl}param-d62e6-doc" as="document-node()">
      <xsl:document>
         <xsl:text>eng</xsl:text>
      </xsl:document>
   </xsl:variable>
   <xsl:param name="Q{}secondaryLanguage"
              select="$Q{urn:x-xspec:compile:impl}param-d62e6-doc ! ( node() )"/>
   <xsl:variable name="Q{urn:x-xspec:compile:impl}param-d62e8-doc" as="document-node()">
      <xsl:document>
         <xsl:text>en</xsl:text>
      </xsl:document>
   </xsl:variable>
   <xsl:param name="Q{}secondaryLanguageCode"
              select="$Q{urn:x-xspec:compile:impl}param-d62e8-doc ! ( node() )"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:variable name="Q{urn:x-xspec:compile:impl}param-d64e1-doc" as="document-node()">
               <xsl:document>
                  <xsl:element name="value" namespace="">
                     <xsl:namespace name="x">http://www.jenitennison.com/xslt/xspec</xsl:namespace>
                     <xsl:text>A title</xsl:text>
            ...
            <xsl:variable name="Q{}titles"
                          select="$Q{urn:x-xspec:compile:impl}param-d64e1-doc ! ( node() )"/>
            <xsl:variable name="Q{urn:x-xspec:compile:impl}param-d64e4-doc" as="document-node()">
               <xsl:document>
                  <xsl:element name="value" namespace="">
                     <xsl:namespace name="x">http://www.jenitennison.com/xslt/xspec</xsl:namespace>
                     <xsl:text>A subtitle</xsl:text>
            ...
            <xsl:variable name="Q{}subtitles"
                          select="$Q{urn:x-xspec:compile:impl}param-d64e4-doc ! ( node() )"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e18-doc"
                    as="document-node()">
         <xsl:document>
            <xsl:text>A title : A subtitle</xsl:text>
         </xsl:document>
      </xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e18"
                    select="$Q{urn:x-xspec:compile:impl}expect-d62e18-doc ! ( node() )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d62e18, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      ...
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d62e18"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario2"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:variable name="Q{urn:x-xspec:compile:impl}param-d73e1-doc" as="document-node()">
               <xsl:document>
                  <xsl:element name="value" namespace="">
                     <xsl:namespace name="x">http://www.jenitennison.com/xslt/xspec</xsl:namespace>
                     <xsl:text>A title</xsl:text>
            ...
            <xsl:variable name="Q{}titles"
                          select="$Q{urn:x-xspec:compile:impl}param-d73e1-doc ! ( node() )"/>
            <xsl:variable name="Q{urn:x-xspec:compile:impl}param-d73e4-doc" as="document-node()">
               <xsl:document>
                  <xsl:element name="value" namespace="">
                     <xsl:namespace name="x">http://www.jenitennison.com/xslt/xspec</xsl:namespace>
                     <xsl:text>A subtitle</xsl:text>
            ...
            <xsl:variable name="Q{}subtitles"
                          select="$Q{urn:x-xspec:compile:impl}param-d73e4-doc ! ( node() )"/>
            <xsl:call-template name="Q{}joinTitleElements">
               <xsl:with-param xmlns:x="http://www.jenitennison.com/xslt/xspec"
                               name="Q{}titles"
                               select="$Q{}titles"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario2-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e30-doc"
                    as="document-node()">
         <xsl:document>
            <xsl:text>A title : A subtitle. Another subtitle</xsl:text>
         </xsl:document>
      </xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e30"
                    select="$Q{urn:x-xspec:compile:impl}expect-d62e30-doc ! ( node() )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d62e30, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d62e30"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario3"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d81e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d81e0-doc ! ( node() )"/>
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:for-each select="$Q{urn:x-xspec:compile:impl}context-d81e0">
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario3-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e39-doc"
                    as="document-node()">
         <xsl:document>
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e39"
                    select="$Q{urn:x-xspec:compile:impl}expect-d62e39-doc ! ( node() )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d62e39, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d62e39"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario4"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d90e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d90e0-doc ! ( node() )"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}context"
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:for-each select="$Q{urn:x-xspec:compile:impl}context-d90e0">
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario4-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e53-doc"
                    as="document-node()">
         <xsl:document>
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e53"
                    select="$Q{urn:x-xspec:compile:impl}expect-d62e53-doc ! ( node() )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d62e53, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d62e53"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario5-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e72-doc"
                    as="document-node()">
         <xsl:document>
            <xsl:element name="title" namespace="">
               <xsl:namespace name="ext">http://exslt.org/common</xsl:namespace>
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e72"
                    select="$Q{urn:x-xspec:compile:impl}expect-d62e72-doc ! ( node() )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d62e72, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d62e72"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario6"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:for-each select="$Q{urn:x-xspec:compile:impl}context-d108e0">
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario6-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e91-doc"
                    as="document-node()">
         <xsl:document>
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e91"
                    select="$Q{urn:x-xspec:compile:impl}expect-d62e91-doc ! ( node() )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d62e91, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d62e91"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario7-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e114" select="()"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d62e114, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d62e114"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario8"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d126e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d126e0-doc ! ( node() )"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}context"
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:for-each select="$Q{urn:x-xspec:compile:impl}context-d126e0">
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario8-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e140-doc"
                    as="document-node()">
         <xsl:document>
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e140"
                    select="$Q{urn:x-xspec:compile:impl}expect-d62e140-doc ! ( node() )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d62e140, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d62e140"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario9"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d135e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d135e0-doc ! ( node() )"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}context"
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:for-each select="$Q{urn:x-xspec:compile:impl}context-d135e0">
               <xsl:call-template name="Q{}monogr"/>
            </xsl:for-each>
         </xsl:variable>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario9-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e174-doc"
                    as="document-node()">
         <xsl:document>
            <xsl:element name="monogr" namespace="">
               <xsl:namespace name="ext">http://exslt.org/common</xsl:namespace>
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e174"
                    select="$Q{urn:x-xspec:compile:impl}expect-d62e174-doc ! ( node() )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d62e174, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d62e174"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario10"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d144e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d144e0-doc ! ( node() )"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}context"
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:for-each select="$Q{urn:x-xspec:compile:impl}context-d144e0">
               <xsl:call-template name="Q{}monogr"/>
            </xsl:for-each>
         </xsl:variable>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario10-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e208-doc"
                    as="document-node()">
         <xsl:document>
            <xsl:element name="monogr" namespace="">
               <xsl:namespace name="ext">http://exslt.org/common</xsl:namespace>
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e208"
                    select="$Q{urn:x-xspec:compile:impl}expect-d62e208-doc ! ( node() )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d62e208, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d62e208"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario11"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d153e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d153e0-doc ! ( node() )"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}context"
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:for-each select="$Q{urn:x-xspec:compile:impl}context-d153e0">
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario11-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e225-doc"
                    as="document-node()">
         <xsl:document>
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e225"
                    select="$Q{urn:x-xspec:compile:impl}expect-d62e225-doc ! ( node() )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d62e225, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d62e225"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario12"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d162e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d162e0-doc ! ( node() )"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}context"
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:for-each select="$Q{urn:x-xspec:compile:impl}context-d162e0">
               <xsl:call-template name="Q{}profileDesc"/>
            </xsl:for-each>
         </xsl:variable>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario12-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>Should display profileDesc data</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e234-doc"
                    as="document-node()">
         <xsl:document>
            <xsl:element name="profileDesc" namespace="">
               <xsl:namespace name="ext">http://exslt.org/common</xsl:namespace>
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d62e234"
                    select="$Q{urn:x-xspec:compile:impl}expect-d62e234-doc ! ( node() )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d62e234, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d62e234"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
