...
<xsl:stylesheet xmlns="http://www.tei-c.org/ns/1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="*[descendant::text() or descendant-or-self::*/@*[string()]]" xmlns:xs="http://www.w3.org/2001/XMLSchema">
        <xsl:copy>
    ...
    <!-- Enlève de manière récursive les noeuds vides -->
    <xsl:template match="@*[string()]" xmlns:xs="http://www.w3.org/2001/XMLSchema">
        <xsl:copy />
    </xsl:template>
</xsl:stylesheet>